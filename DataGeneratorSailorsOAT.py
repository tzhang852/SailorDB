...
numSailors = 2000 
outfile = open("insertOAT_sailors","w") 
for i in range(1,numSailors+1):
	outString = 'insert into Sailors values('
	outString += str(i)   # id
	outString += ','
	outString += '"Bob'
...
numBoats = 1000 
outfile = open("insertOAT_boats","w") 
for i in range(101,numBoats+101):
	outString = 'insert into Boats values('
	outString += str(i)   # bid
	outString += ','
	outString += '"guppy'
...
numReservations = 10000 
outfile = open("insertOAT_reserve","w") 
for i in range(1,numReservations+1):
	outString = 'insert into Reserve values('
